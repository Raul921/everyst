...
class SMTPConfigurationViewSet(viewsets.ModelViewSet):
    """
    API endpoint for managing SMTP configurations.
    Includes a /test_connection/ endpoint for verifying SMTP settings.
    """
    ...
    def test_connection(self, request, pk=None):
        """
        Test SMTP connection for the given configuration.
        Returns clear success/error message.
        """
